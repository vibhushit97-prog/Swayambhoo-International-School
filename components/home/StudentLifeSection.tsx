  ...
  return (
    <section className="py-20 lg:py-28 bg-[#E7EDE2] border-b border-[#C9D8C8]">
      <Container>
        ...
        <div className="bg-white border border-[#DEDCCF] p-6 sm:p-10 mb-12 shadow-sm">
          <div className="max-w-3xl mb-8">
            <span className="text-xs font-bold uppercase tracking-widest text-[#B88A2A] block mb-2">
              Official Institutional Attire
            </span>
            <h3 className="font-serif text-2xl sm:text-3xl font-bold text-[#0F4735] mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Boys Uniform Card */}
            <div className="border border-[#DEDCCF] bg-[#F7F3E8] p-4 group">
              <div className="relative aspect-4/3 w-full bg-white overflow-hidden mb-4 border border-[#DEDCCF]">
                <Image
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <h4 className="font-serif font-bold text-base text-[#0F4735]">
                    Boys Formal & Daily Uniform
                  </h4>
                  <span className="text-[10px] uppercase tracking-wider font-semibold text-[#0F4735] bg-[#E7EDE2] px-2 py-0.5 border border-[#C9D8C8]">
                    Official Spec
                  </span>
                </div>
                <p className="text-xs text-[#26332E] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 border border-[#DEDCCF] hover:border-[#B88A2A] transition-colors">
            <Users className="w-6 h-6 text-[#B88A2A] mb-3" />
            <h4 className="font-serif font-bold text-lg text-[#0F4735] mb-2">
              Four House Systems
            </h4>
          ...
          <div className="bg-white p-6 border border-[#DEDCCF] hover:border-[#B88A2A] transition-colors">
            <Palette className="w-6 h-6 text-[#B88A2A] mb-3" />
            <h4 className="font-serif font-bold text-lg text-[#0F4735] mb-2">
          ...
          <div className="bg-white p-6 border border-[#DEDCCF] hover:border-[#B88A2A] transition-colors">
            <Sparkles className="w-6 h-6 text-[#B88A2A] mb-3" />
            <h4 className="font-serif font-bold text-lg text-[#0F4735] mb-2">
